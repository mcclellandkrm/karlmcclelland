  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="container-wide relative z-20 text-center">
        ...
        <p className="text-xl md:text-2xl text-neutral-300 font-light leading-relaxed max-w-2xl mx-auto mb-12">
          Immersive Google Street View tours for boutique hospitality and luxury properties.
        </p>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 text-white flex flex-col items-center gap-2 opacity-50">
